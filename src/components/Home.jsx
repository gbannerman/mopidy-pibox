...
export default class Home extends React.Component {
	...
	render() {
        ...
        <ul>
        	...
        	<li className="nav-item-search"><Link className="Link" to="/search/"><img className="icon" alt="search icon" src="https://d30y9cdsu7xlg0.cloudfront.net/png/14173-200.png" /></Link></li>
        </ul>
