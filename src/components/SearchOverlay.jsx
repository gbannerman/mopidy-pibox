		    ...
		    {(state) => (
		      <div style={{
		        ...
		        ...transitionStyles[state]
		      	...
		      	<Search tracklist={this.props.tracklist} playing={this.props.playback === 'playing'} onSelect={this.props.onSelect} search={this.props.search} onSearch={this.props.onSearch}/>
		      </div>
		    )}
		  </Transition>
		);
